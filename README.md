[![Run App Lueders, Joshua](https://github.com/JoshLueders/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/JoshLueders/GithubActions/actions/workflows/ci.yml)
